                    ...
                    <div class="col-md-8 offset-md-2 col-xs-12 q-pa-md">
                        <q-card flat class="text-blue-grey-14">
                            <div class="row items-center">
                                ...
                                <div class="col-md-6">
                                    <q-card-section>
                                        <div class="text-h4">toko key</div>
                                    ...
                                    >
                                        ...
                                        <q-card-section>
                                            <q-btn class="full-width" type="submit" unelevated color="black" label="Login"/>
                                            <q-btn class="full-width q-mt-md" :to="{ name: 'registerPage'}" flat unelevated color="black" label="Register"/>
                                        </q-card-section>
                                    </q-form>
                                </div>
                            </div>
